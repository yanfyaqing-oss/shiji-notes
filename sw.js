const CACHE = 'shiji-v28';
const ASSETS = ['./','./index.html','./styles.css?v=28','./standard.css?v=28','./spine-workflow-standard.html','./learning-plan.js?v=28','./app.js?v=28','./cloud.js?v=28','./manifest.webmanifest','./icon.svg'];
