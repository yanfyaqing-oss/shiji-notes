const CACHE = 'shiji-v27';
const ASSETS = ['./','./index.html','./styles.css?v=27','./standard.css?v=27','./spine-workflow-standard.html','./learning-plan.js?v=27','./app.js?v=27','./cloud.js?v=27','./manifest.webmanifest','./icon.svg'];
