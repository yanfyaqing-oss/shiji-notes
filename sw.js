const CACHE = 'shiji-v30';
const ASSETS = ['./','./index.html','./styles.css?v=30','./standard.css?v=30','./spine-workflow-standard.html','./learning-plan.js?v=30','./app.js?v=30','./cloud.js?v=30','./manifest.webmanifest','./icon.svg'];
